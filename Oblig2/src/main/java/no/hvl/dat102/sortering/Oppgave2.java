...
public class Oppgave2 {
    public static void kjoerTest(int storrelse) {
        System.out.println("Kjører med " + storrelse + " elementer: ");
        final int ANTALL_TABELLER = 10;
        final int STORRELSE = storrelse;
        ...
        System.out.println("Gjennomsnittelig tid tatt med sortering ved innsetting: " + tidTatt / ANTALL_TABELLER + "ms");
        ...
        for (int i = 0; i < testArr.length; i++) {
            utvalgssortering(testArr[i]);
        }
        slutt = System.currentTimeMillis();
        tidTatt = slutt - start;

        System.out.println("Gjennomsnittelig tid tatt med utvalgssortering: " + tidTatt / ANTALL_TABELLER + "ms");
        ...
        start = System.currentTimeMillis();
        for (int i = 0; i < testArr.length; i++) {
            flettesortering(testArr[i]);
        }
        slutt = System.currentTimeMillis();
        tidTatt = slutt - start;

        System.out.println("Gjennomsnittelig tid tatt med flettesortering: " + tidTatt / ANTALL_TABELLER + "ms");
        ...
        System.out.println("Gjennomsnittelig tid tatt med kvikksortering: " + tidTatt / ANTALL_TABELLER + "ms");
        System.out.println();
    }
